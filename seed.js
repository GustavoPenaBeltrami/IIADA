...
async function seed() {
    ...
    const course = await prisma.course.create({ 
        data: {
            title: "Becoming an Independent Dealer in Indiana",
            description: "This program, outlined in Senate Enrolled Act 222, represents a collaborative effort between the Secretary of State's office and the Independent Automobile Dealers Association.The training course will provide invaluable knowledge on licensing requirements, laws, and rules essential for operating as a used motor vehicle dealer in Indiana.",
    ...
    const sections = await prisma.section.createMany({
        data: [
            {
                title: "Introduction from SOS and IIADA President",
                description: "This is a brief introduction from the SOS and the IIADA President as well as legal disclosures.",
                videoUrl: "https://streamable.com/e/idgp6s?loop=0",
                duration: 143,
                number: 1,
                courseId: course.id,
            },
            {
                title: "Title Delivery and Documentation",
                description: "This section will cover information about delivering the vehicle title to customers, documentation, and best practices around managing documents.",  
                videoUrl: "https://streamable.com/e/uoz12y?loop=0",
                duration: 598,
                number: 2,
                courseId: course.id,
            },
            {
                title: "Salvaged Titles, Interim Plates, Notary Publics",
                description: "In this section, we will cover the dealing with salvaged titles, dealer plates, and notary publics. Each of these are important events that will come up over your lifetime as a dealer.",
                videoUrl: "https://streamable.com/e/olxvnj?loop=0",
                duration: 501,
                number: 3,
                courseId: course.id,
            },
            {
                title: "Non-US Vehicles, Additional Fees, and Audit Information",
                description: "In this section, you will learn about non-US vehicle purchases and how they differ from a typical US purchase. We will also cover information about additional fees and what an audit would look like should you ever have one.",
                videoUrl: "https://streamable.com/e/7kg27s?loop=0",
                duration: 325,
                number: 4,
                courseId: course.id,
            },
            {
                title: "Resources, Renewals, and Association Information",
                description: "In this last section of the course, you will learn about available resources through the IIADA, what enforcement actions you could face should violations occur, and your association contact information.",
                videoUrl: "https://streamable.com/e/qcyjiv?loop=0",
                duration: 450,
                number: 5,
                courseId: course.id,
            },
