  ...
  return (
    <div className="flex md:flex-row flex-col md:mt-16 mt-0 gap-10 pb-4">
      ...
      <div className="md:w-5/12 flex flex-col md:pt-14 pt-6">
        ...
        <Link href="/catalog" className="w-fit block mt-10 blue-bg p-4 px-6 rounded-xl special-button text-white font-normal text-xl transition-all duration-300">See all courses</Link>
      </div>
