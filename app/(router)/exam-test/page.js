  ...
  return (
    <div className="min-h-[80vh]">
      ...
      <div className="flex flex-row justify-between items-center py-5">
        <Link href="/courses" className="special-button p-2 rounded-lg duration-300 transition-all">{`< Previous`}</Link>
        <Link href="/exam-test" className="special-button p-2 rounded-lg duration-300 transition-all">{`Next >`}</Link>
      </div>
    </div>
  );
}
