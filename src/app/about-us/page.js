  ...
  return (
    <>
      ...
      <div className="flex flex-col gap-y-6 lg:mb-56">
        ...
        <Link href="https://www.indianaiada.com/af_about_us" target="_blank" className="w-fit mx-auto block mt-10 blue-bg p-4 px-6 rounded-xl login-button text-white font-normal text-xl transition-all duration-300">More info</Link>
      </div>
